...
<html lang="fr">
        ...
        <nav class="navigation" id="navigation">
            ...
            <ul class="navigation-menu">
                <li class="navigation-menu__item current">
                    <a href="#school">Accueil</a>
                </li>
                <li class="navigation-menu__item">
                    <a href="#about">À propos</a>
                </li>
                <li class="navigation-menu__item">
                    <a href="#pratique">Infos pratiques</a>
                </li>
                <li class="navigation-menu__item">
                    <a href="#salles">Nos clubs</a>
                </li>
                <li class="navigation-menu__item">
        ...
        <div class="main" >
            ...
            <section id="school" class="section">
                ...
                <div class="section-content">
                    <section class="section-content__text content left invisible">
                    ...
                    <figure class="section-content__img invisible right">
                        <img src="build/assets/images/2.jpg" alt="">
                    </figure>
                </div>
            </section>
            ...
            <section id="pratique" class="section">
                ...
                <p class="center">Si vous n'êtes pas famillier avec notre école, vous vous posez sans doute quelques questions</p>

                <div class="carousel-container">
                    <div class="carousel">
                        <div class="carousel-item active">
                            <div class="carousel-text left invisible">
                            ...
                            <figure class="carousel-img right invisble">
                                <img src="build/assets/images/qui.jpg" alt="">
                            </figure>
                        </div>
                        ...
                        <div class="carousel-item">
                            ...
                            <figure class="carousel-img">
                                <img src="build/assets/images/equipement.jpg" alt="">
                            </figure>
                        </div>
                        ...
                        <div class="carousel-item">
                            ...
                            <figure class="carousel-img">
                                <img src="build/assets/images/combien.jpg" alt="">
                            </figure>
                        </div>
                        ...
                        <div class="carousel-item">
                            ...
                            <figure class="carousel-img">
                                <img src="build/assets/images/assurance.jpg" alt="">
                            </figure>
                        </div>
                    </div>
            ...
            <div class="section-img first">
                <p class="section-img__texte"></p>
            </div>

            <section id="ressources" class="section">
                <h2 class="section-title">Ressources</h2>
                <p class="center">Quelques ressources et documents utiles</p>
                    ...
                    <div class="carousel">
                        <div class="carousel-item active">
                            <div class="carousel-text left invisible">
                                ...
                                <div class="carousel-text__answer">
                                    <p>
                                        Cliquez <a href="http://www.larp.be/wp-content/uploads/2017/12/Trait%C3%A9-Escrime-Ludique.pdf" class="link" rel="external" target="_blank" title="Voir le document de référence sur l'escrime ludique">ici</a> pour accéder au document de référence sur l'escrime ludique.
                                    </p>
                                </div>
                                <p class="carousel-text__title">
                                    B.W.A.T
                                ...
                                <div class="carousel-text__answer">
                                    <p>
                                        Nous mettons à votre disposition une série d'exercice que vous retrouverez également lors de nos séances. Cliquez <a href="build/assets/files/exercices.pdf" class="link" target="_blank" title="Voir les exercices">ici</a>
                                    </p>
                                </div>
                            </div>
                            <figure class="carousel-img right invisible">
                                <img src="build/assets/images/ressources.jpg" alt="">
                            </figure>
                        </div>
                    </div>
                </div>
            ...
            <div class="section-bg">
                <section id="contact" class="section">
                    ...
                    <p class="center">Si vous recherchez d'autres informations, n'hésitez pas à posez vos questions via notre formulaire de contact. </p>
                    ...
                    <?php
                        ...
                        if(isset($_POST["name"]) && isset($_POST["subject"]) && isset($_POST["sender_email"]) && isset($_POST["message"])) {
                            ...
                            if(empty(array_filter($errors))){
                                mail("anne.m.remacle@gmail.com", $_POST["subject"], "nouveau message de ".$_POST["sender_email"].": ".$_POST["message"]);
                    ...
                    <form action="#contact" method="POST" class="form" role="form">
                        <?php if(isset($_POST["name"]) && empty(array_filter($errors))): ?>
            ...
            <section id="socials" class="socials section">
                ...
                <div class="socials-container">
                    <a href="https://fr-fr.facebook.com/Riddle-of-Steel-296714857049503/" class="socials-single invisible" target="_blank">
                    ...
                    <a href="https://www.youtube.com/user/0Riddleofsteel0" class="socials-single invisible" target="_blank">
                        <span class="fa-stack fa-2x socials-single__icon">
                            <i class="fas fa-circle fa-stack-2x"></i>
                    ...
                    <a href="mailto:0riddleofsteel0@gmail.com" class="socials-single invisible" target="_blank">
                        <span class="fa-stack fa-2x socials-single__icon">
                            <i class="fas fa-circle fa-stack-2x"></i>
    ...
    <script src="build/js/animate.js"></script>
    <script src="build/js/script.js"></script>
    <script src="build/js/custom.js"></script>
    <script src="build/js/jquery.scrollTo.min.js"></script>
